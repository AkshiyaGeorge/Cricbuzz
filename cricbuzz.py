...
# -------------------- API Config --------------------
BASE_HEADERS = {
    "x-rapidapi-key": "61775b958amshfe2a80227e9bef7p1659b5jsn00e812e129d6",
...
def get_trending_players():
    return [
        #Indian
        {"name": "Shikhar Dhawan", "teamName": "India ⚐", "role": "Batsman", "age": 38, "tag": "Veteran"},
        {"name": "KL Rahul", "teamName": "India ⚐", "role": "Wicketkeeper Batsman", "age": 32, "tag": "Comeback"},
        {"name": "Mukesh Choudhary", "teamName": "India ⚐", "role": "Bowler", "age": 28, "tag": "Swing Specialist"},
        {"name": "Kuldeep Yadav", "teamName": "India ⚐", "role": "keeper", "age": 30, "tag": "Left-arm Chinaman"},
        {"name": "MS Dhoni", "teamName": "India ⚐", "role": "Captian", "age": 43, "tag": "All rounder"},
        {"name": "Ruturaj Gaikwad", "teamName": "India ⚐", "role": "keeper", "age": 27, "tag": "Technically Sound"},
        {"name": "Marco Jansen", "teamName": "South Africa ⚐", "role": "All-rounder", "age": 24, "tag": "Rising Star"},
        {"name": "Rashid Khan", "teamName": "Afghanistan ⚐", "role": "Bowler", "age": 26, "tag": "Spin Wizard"},
        {"name": "Jos Buttler", "teamName": "England ⚐", "role": "Wicketkeeper Batsman", "age": 34, "tag": "Power Hitter"},
        {"name": "Patrick Heron", "teamName": "Cayman Islands ⚐", "role": "All-rounder", "age": 27, "tag": "Associate Hero"},
        {"name": "Faf du Plessis", "teamName": "South Africa ⚐", "role": "keeper", "age": 40, "tag": "Fitness Icon"},
        {"name": "MS Dohni", "teamName" : "India ⚐", "role": "captain", "age": 45, "tag": "Leggie"},
        {"name":"Sachin Tendulkar", "teamName" : "India ⚐", "role": "captain", "age": 41, "tag": "Rising Star"},
        {"name": "Virat Kohli", "teamName": "India ⚐", "role": "keeper", "age": 36, "tag": "Rising Star"},
        {"name": "Rohit Sharma", "teamName": "India ⚐", "role": "Batsman", "age": 37, "tag": "Leggie"},
        {"name": "Jasprit Bumrah", "teamName": "India ⚐", "role": "Bowler", "age": 31, "tag": "Rising Star"},
        {"name": "KL Rahul", "teamName": "India", "role ⚐": "Wicketkeeper Batsman","age": 32, "tag": "Rising Star"},
        {"name": "Ravindra Jadeja", "teamName": "India ⚐", "role": "All-rounder","age": 36, "tag": "Leggie"},
        {"name": "Pat Cummins", "teamName": "Australia ⚐", "role": "Bowler","age": 32, "tag": "Technically Sound"},
        {"name": "Steve Smith", "teamName": "Australia ⚐", "role": "keeper","age": 36, "tag": "Rising Star"},
        {"name": "David Warner", "teamName": "Australia ⚐", "role": "captain","age": 38, "tag": "Technically Sound"},
        {"name": "Mitchell Starc", "teamName": "Australia ⚐", "role": "Bowler","age": 35, "tag": "Technically Sound"},
        {"name": "Glenn Maxwell", "teamName": "Australia ⚐", "role": "All-rounder","age": 36, "tag": "Leggie"},
        {"name": "Joe Root", "teamName": "England ⚐", "role": "captain", "age": 34, "tag": "Technically Sound"},
        {"name": "Ben Stokes", "teamName": "England ⚐", "role": "All-rounder","age": 33, "tag": "Swing Specialist"},
        {"name": "Jos Buttler", "teamName": "England ⚐", "role": "Wicketkeeper Batsman", "age": 34, "tag": "Power Hitter"},
        {"name": "Quinton de Kock", "teamName": "South Africa ⚐", "role": "Wicketkeeper Batsman", "age": 32, "tag": "Leggie"},
        {"name": "Kagiso Rabada", "teamName": "South Africa ⚐",  "role": "captain","age": 30, "tag": "Swing Specialist"},
        {"name": "Aiden Markram", "teamName": "South Africa ⚐", "role": "keeper","age": 30, "tag": "Technically Sound"},
        {"name": "Kane Williamson", "teamName": "New Zealand ⚐",  "role": "Batsman","age": 35, "tag": "Swing Specialist"},
        {"name": "Trent Boult", "teamName": "New Zealand ⚐",  "role": "captain","age": 36, "tag": "Technically Sound"},
        {"name": "Devon Conway", "teamName": "New Zealand ⚐",  "role": "Batsman","age": 33, "tag": "Swing Specialist"},
        {"name": "Babar Azam", "teamName": "Pakistan ⚐",  "role": "Batsman","age": 31, "tag": "Technically Sound"},
        {"name": "Shaheen Afridi", "teamName": "Pakistan ⚐",  "role": "captain","age": 28, "tag": "Swing Specialist"},
        {"name": "Mohammad Rizwan", "teamName": "Pakistan ⚐","role": "Wicketkeeper Batsman", "age": 32, "tag": "Technically Sound"},
        {"name": "Rashid Khan", "teamName": "Afghanistan ⚐",  "role": "captain","age": 26, "tag": "Technically Sound"},
        {"name": "Mohammad Nabi", "teamName": "Afghanistan ⚐",  "role": "All-rounder","age": 40, "tag": "Swing Specialist"},
        {"name": "Rahmanullah Gurbaz", "teamName": "Afghanistan ⚐", "role": "keeper ", "age": 24, "tag": "Technically Sound"},
    ]
...
# 👨🏻 Players Stats + Batting + Bowling
    ...
    matched_players = search_players(search_name) if search_name else []
    ...
    if selected_label:
        ...
        # 🔄 Enrich with trending player info if available
        trending_info = next(
            (tp for tp in get_trending_players() if tp["name"].lower() == selected_player.get("name", "").lower()),
            {}
        )
        is_trending = bool(trending_info)
        ...
        if is_trending:
            st.markdown(f"- 🏏 Role: **{trending_info.get('role')}**")
            st.markdown(f"- 🎂 Age: **{trending_info.get('age')}**")
            st.markdown(f"- 🏷️ Tag: _{trending_info.get('tag')}_ ⭐")
        else:
            st.info("Detailed profile info is available only for trending players.")
        ...
        # 🌟 Trending Players (fallback when no player is selected)
        st.markdown("### 🌟 Trending Players")
        trending_players = get_trending_players()
        cols = st.columns(2)
        for i, player in enumerate(trending_players):
            with cols[i % 2]:
                st.markdown(f"""
                ### {player.get('name', 'Unknown')} ({player.get('teamName', 'Unknown')})
                - 🏏 Role: **{player.get('role', 'Not Available')}**
                - 🎂 Age: **{player.get('age', 'Not Available')}**
                - 🏷️ Tag: _{player.get('tag', 'No Tag')}_ ⭐
                """)

        # 👤 Search Results (if search input exists but no selection made)
        if search_name and matched_players:
